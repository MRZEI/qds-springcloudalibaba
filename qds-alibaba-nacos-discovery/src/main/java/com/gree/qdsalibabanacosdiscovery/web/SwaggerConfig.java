package com.gree.qdsalibabanacosdiscovery.web;
...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        ...
        useridPar.name("token").defaultValue("").description("访问身份令牌").modelRef(new ModelRef("string"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                // 标题
                .title("在线接口测试平台：qds-alibaba-nacos-config服务")
                // 简介
